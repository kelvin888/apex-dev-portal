...
const commands = [
  ...
  {
    name: "apex dev",
    desc: "Start a local development server with hot-reload.",
  },
  ...
  {
    name: "apex keys register <pubkey>",
    desc: "Register a signing certificate.",
  },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-lg text-gray-600 mb-10">
          Use the APEX CLI to build, test, and deploy mini-apps.
        </p>
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 pr-6 font-medium text-gray-900">
                      Command
                    </th>
                ...
                <tbody className="text-gray-600 divide-y">
                  {commands.map(({ name, desc }) => (
                    <tr key={name}>
                      <td className="py-2 pr-6 font-mono text-primary-600 whitespace-nowrap">
                        {name}
                      </td>
          ...
          <section id="dev">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              <div className="flex gap-4">
                <code className="font-mono text-primary-600 bg-primary-50 px-2 py-1 rounded shrink-0">
                  --registry &lt;url&gt;
                </code>
                <span className="self-center">
                  Override the registry URL for all commands.
                </span>
              </div>
              <div className="flex gap-4">
                <code className="font-mono text-primary-600 bg-primary-50 px-2 py-1 rounded shrink-0">
              ...
              <div className="flex gap-4">
                ...
                <span className="self-center">Show help for any command.</span>
              </div>
            </div>
          </section>
        </div>
